...
from main.views import UserViewSet, PlaylistViewSet, SongViewSet, SearchView, IndexView, ConnectSongAndPlaylistView, RemoveConnectSongAndPlayView, SongDownloadingProxy, SearchResultView
...
urlpatterns = [
    ...
    path('api/v1/get-search-result/<str:task_id>/', SearchResultView.as_view()),
